...
#ifndef FACEAUTHENTICATOR_SWIFT_H
#define FACEAUTHENTICATOR_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="FaceAuthenticator",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
///   </li>
/// </ol>
SWIFT_CLASS("_TtC17FaceAuthenticator27FaceAuthenticatorController")
...
SWIFT_CLASS("_TtC17FaceAuthenticator37FaceAuthenticatorCustomViewController")
@interface FaceAuthenticatorCustomViewController : NSObject <AVCapturePhotoCaptureDelegate, AVCaptureVideoDataOutputSampleBufferDelegate>
...
SWIFT_CLASS("_TtC17FaceAuthenticator23FaceAuthenticatorResult")
...
SWIFT_CLASS("_TtC17FaceAuthenticator7JWTUtil")
